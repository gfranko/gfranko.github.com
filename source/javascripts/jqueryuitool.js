...
$.fn.themeswitcher = function(settings){
	...
	$.fn.spShow = function(){ $(this).css({top: button.offset().top + options.buttonHeight + 6, left: button.position().left}).slideDown(50); button.css(button_active); options.onOpen(); }
